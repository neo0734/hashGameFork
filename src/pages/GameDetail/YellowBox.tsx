...
const YellowBox: React.FC<{
  ...
  return (
    <div className="h-[36px] w-fit bg-[#FFCC02]  border-t-4 border-b-4 text-black font-medium pr-[8px] pl-[8px] relative  items-center flex text-[14px]">
      ...
      {showDesc1 ? showDesc1 + ' : ' : ''} {dt} {showDesc2 ? showDesc2 : ''}
    </div>
  );
};
